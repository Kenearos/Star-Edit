...
This policy applies to **`Kenearos/Star-Edit`**. It is derived from our engineering
...
1. Email **kenearos@googlemail.com** with the subject prefix `[SECURITY] Star-Edit`.
...
| Version | Supported |
|---------|-----------|
| Latest release of `Star-Edit` | ✅ Yes |
